...
with(this){return _c('p',[_v("Real estate agents often struggle to manage buyers and sellers through messaging apps."),_c('br'),_v(" "),_c('strong',[_v("MatchEstate")]),_v(" provides a "),_c('strong',[_v("streamlined solution")]),_v(" to:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Track buyers and sellers easily")]),_v(", including their "),_c('strong',[_v("preferences and offerings")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("Enable fast and accurate matching")]),_v(" between buyers and sellers.")]),_v(" "),_c('li',[_c('strong',[_v("Designed for CLI users")]),_v(", ensuring efficiency for those who prefer typing over clicking.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("With "),_c('strong',[_v("MatchEstate")]),_v(", real estate agents can save time, stay organized, and close deals faster.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 6 Mar 2025, 16:44:44 GMT+8]")])])])}
}];
